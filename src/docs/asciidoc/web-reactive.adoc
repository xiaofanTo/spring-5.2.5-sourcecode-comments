...
the reactive <<webflux-client, `WebClient`>>, support for <<webflux-com.xiaohuan.Test, testing>>,
...
[[webflux-com.xiaohuan.Test]]
== Testing
[.small]#<<web.adoc#testing, Same in Spring MVC>>#

The `spring-com.xiaohuan.Test` module provides mock implementations of `ServerHttpRequest`,
