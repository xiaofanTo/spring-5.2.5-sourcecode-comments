...
----
	...
	public class SampleController {
		...
		@GetMapping("/sample")
		public String com.xiaohuan.Test(Model model) {
...
----
	...
	class SampleController {
		...
		@GetMapping("/sample")
		fun com.xiaohuan.Test(model: Model): String {
...
https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc/src/com.xiaohuan.Test/java/org/springframework/web/servlet/view/script[Java], and
https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc/src/com.xiaohuan.Test/resources/org/springframework/web/servlet/view/script[resources],
