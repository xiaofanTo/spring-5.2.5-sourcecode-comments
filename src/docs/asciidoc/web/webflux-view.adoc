...
https://github.com/spring-projects/spring-framework/tree/master/spring-webflux/src/com.xiaohuan.Test/java/org/springframework/web/reactive/result/view/script[Java], and
https://github.com/spring-projects/spring-framework/tree/master/spring-webflux/src/com.xiaohuan.Test/resources/org/springframework/web/reactive/result/view/script[resources],
