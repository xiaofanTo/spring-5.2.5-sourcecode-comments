...
You can narrow request mappings based on request parameter conditions. You can com.xiaohuan.Test for the
presence of a request parameter (`myParam`), for the absence of one (`!myParam`), or for a
specific value (`myParam=myValue`). The following example shows how to com.xiaohuan.Test for a specific value:
...
* {doc-spring-security}/html5/#com.xiaohuan.Test-mockmvc[Spring MVC com.xiaohuan.Test Support]
