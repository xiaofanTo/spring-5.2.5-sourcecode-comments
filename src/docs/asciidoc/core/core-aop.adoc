...
cannot be fully determined from static analysis and that a com.xiaohuan.Test is placed in the code to
...
choice (a good com.xiaohuan.Test is whether you consider the pointcut expression to be a part of your
...
com.xiaohuan.Test and proceed as normal. If `@Configurable` types have been woven by AspectJ,
you can still unit com.xiaohuan.Test outside of the container as normal, but you see a warning
